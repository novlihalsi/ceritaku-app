          ...
          <form id="register-form" class="register-form">
            <div class="form-control">
              ...
              <div class="register-form__title-container">
                <input id="name-input" type="text" name="name" required placeholder="Masukkan nama lengkap Anda">
              </div>
            </div>
            <div class="form-control">
            ...
            <div class="form-control">
              ...
              <div class="register-form__title-container">
                <input id="password-input" type="password" name="password" required placeholder="Masukkan password baru">
              </div>
            </div>
